...
email varchar(50),phone_number varchar(20),hire_date varchar(15),job_id int,salary int,manager_id int,
department_id int,foreign key(job_id) references jobs(job_id)ON DELETE CASCADE ON UPDATE CASCADE,
foreign key(department_id) references departments(department_id)ON DELETE CASCADE ON UPDATE CASCADE,
foreign key(manager_id) references employees(employee_id)ON DELETE CASCADE ON UPDATE CASCADE);

create table jobs(job_id int primary key,job_title varchar(40),min_salary int,max_salary int);

create table dependents(dependent_id int primary key,first_name varchar(20),last_name varchar(20),
relationship varchar(20),employee_id int,
foreign key(employee_id) references employees(employee_id) ON DELETE CASCADE ON UPDATE CASCADE);

create table departments(department_id int primary key,department_name varchar(30),
location_id int,foreign key(location_id) references locations(location_id) ON DELETE CASCADE
ON UPDATE CASCADE);

create table locations(location_id int primary key,street_address varchar(50),postal_code varchar(10),
city varchar(20),state_province varchar(30),country_id varchar(10),
foreign key(country_id) references countries(country_id)ON DELETE CASCADE ON UPDATE CASCADE);

create table countries(country_id varchar(10) primary key,country_name varchar(50),region_id int,
foreign key(region_id) references regions(region_id) ON DELETE CASCADE ON UPDATE CASCADE);

create table regions(region_id int primary key,region_name varchar(50));

-- ALTER TABLE  Dept RENAME departments;
...
INSERT INTO locations(location_id,street_address,postal_code,city,state_province,country_id) 
VALUES(1500,'2011 Interiors Blvd','99236','South SanFrancisco','California','US');
INSERT INTO locations(location_id,street_address,postal_code,city,state_province,country_id)
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id)
 VALUES(102,'Lex','DeHaan','lex.de haan@sqltutorial.org','515.123.4569','1993-01-13',5,17000.00,100,9);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) 
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) 
VALUES(112,'JoseManuel','Urman','jose manuel.urman@sqltutorial.org','515.124.4469','1998-03-07',6,7800.00,108,10);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id)
...
select first_name,last_name,hire_date from employees where hire_date between '1995-01-01' and '1997-01-01';
select job_title from jobs where min_salary<5000;
select lower(email) from employees;
select first_name from employees where hire_date like "1995%";

INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id)
VALUES(207,'PAUL','Newton','paul.newton@sqltutorial.org','515.127.4563','1997-12-24',13,2900.00,114,11);   
